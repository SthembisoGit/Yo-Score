...
8. `feature/reference-panel` -> Read-only docs and hints for each challenge
...
- Keep `Scoring.md` and `Security.md` updated
- Use mock data for frontend early testing
- MVP scoring remains rule-based; advanced analytics can be evaluated in later phases
